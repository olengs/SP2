...
void SceneMainMenu::Init()
{
	...
	camera.Init(Vector3(0, 0, 40), Vector3(0, 0, 0), Vector3(0, 1, 0));
	...
	meshList[GEO_FRONT]->textureID = LoadTGA("Image//Option_BGMOn.tga");
	meshList[GEO_FRONT]->textureID = LoadTGA("Image//Option_BGMOff.tga");
	meshList[GEO_FRONT]->textureID = LoadTGA("Image//menu.tga");
...
void SceneMainMenu::Render()
{
	...
	modelStack.Translate(14, arrowY, 0);
	modelStack.Rotate(90, 0, 1, 0);
	modelStack.Scale(2, 2, 2.3);
...
void SceneMainMenu::CalculateFrameRate()
{
